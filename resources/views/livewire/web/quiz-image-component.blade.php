<div>
    <div class="min-h-screen bg-gray-100 dark:bg-darkBg text-gray-800 dark:text-gray-200 flex items-center justify-center">
        <div class="w-full max-w-4xl">
            <h1 class="text-3xl font-bold text-center mb-6 text-gray-800 dark:text-gray-100">Student name to image Quiz</h1>
                        ...
                        <div class="p-6 bg-gray-100 border dark:bg-gray-800 rounded-lg shadow-md hover:shadow-lg hover:border-gray-400 transition-all duration-200">
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                @foreach ($question['options'] as $option)
                                    <!-- Label for Options -->
                                    <label
                                        class="p-3 rounded-lg flex gap-2 justify-center items-center my-auto text-center font-medium cursor-pointer transition-all duration-200
